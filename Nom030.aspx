<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Nom030.aspx.vb" Inherits="EncuestaVirtualOficina.Nom030" %>
                        ...
                        <div class="col-md-12 ">
                            <div class="row">
                                ...
                                <div class="col-md-10 text-center mb-3">
                                    ...
                                    <asp:Label ID="Label8" runat="server" Visible="true" Font-Bold="True" Font-Size="16pt" ForeColor="Black">Diagnóstico De Seguridad  y Salud en el Trabajo (NOM-030-STPS)</asp:Label>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="col-md-1"> </div>
                                <div class="col-md-3">
                                    <telerik:RadPanelBar ID="RadPanelBar1" Runat="server" AllowCollapseAllItems="True" AppendDataBoundItems="True" 
                                        ExpandMode="SingleExpandedItem" ToolTip="Selecciona la encuesta para contestar." Width="99%" Skin="Metro">
                                    </telerik:RadPanelBar>
                                </div>
                                <div class="col-md-9 mb-3 justify-content-center">
...
<ItemStyle Width="50%"></ItemStyle>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Columna1" UniqueName="Columna1" Visible="False">
                                                    <ItemTemplate>
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <telerik:RadComboBox ID="RadComboBox1" Skin="Metro" Runat="server" Tooltip="Seleccione un elemento" Width="100%">
                                                                        <Items>
                                                                            <telerik:RadComboBoxItem runat="server" Text="Cumple" Value="-1" />
                                                                            <telerik:RadComboBoxItem runat="server" Text="No Cumple" Value="2" />
                                                                        </Items>
                                                                    </telerik:RadComboBox>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <telerik:RadTextBox runat="server" Width="100%" Height="50px" onkeydown = "return (event.keyCode!=13);" ID="RadTexbox1" AutoPostBack="false" Skin="Metro"></telerik:RadTextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </ItemTemplate>
