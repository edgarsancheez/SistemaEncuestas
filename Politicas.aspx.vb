        ...
        Try
            ...
            If LIndicadorRespuesta.Text = 0 Then
                If ChkRespuesta.Visible = False Then
                    ...
                    If TexPreguntaAbierta.Text.Trim = "" Then
                        Lerror.Text = "Es necesario responder las preguntas para continuar la encuesta."
                        Exit Sub
                    End If
                Else
            ...
            Else
                ...
                ElseIf RbRespuesta2.Visible = False Then
                    ...
                    If TexPreguntaAbierta.Text.Trim = "" Then
                        Lerror.Text = "Es necesario responder las preguntas para continuar."
                        Exit Sub
                    End If

                Else
                    If RbRespuesta2.SelectedValue = "" Then
                        Lerror.Text = "Es necesario responder la información."
                        Exit Sub
                    ElseIf TexPreguntaAbierta.Text = "" Then
                        Lerror.Text = "Es necesario escribas tu nombre como esté en tu INE."
                        Exit Sub
                    Else
